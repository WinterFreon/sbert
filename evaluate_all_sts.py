...
def evaluate_cosine_spearman(model, tokenizer, sents1, sents2, scores, device):
    ...
    emb1 = torch.cat(all_embeddings1, dim=0)
    emb2 = torch.cat(all_embeddings2, dim=0)
...
def main():
    ...
    tasks = {
        ...
        "STS-B": ("glue", "validation")  # GLUE's test set requires submission
    }
